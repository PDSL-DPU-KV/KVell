...
mainDir="${scriptDir}/.."
tcmalloc="env LD_PRELOAD=${HOME}/repo/gperftools/.libs/libtcmalloc.so "
...
cat ${mainDir}/main.c | perl -pe 's://.nb_load_injectors = 8:.nb_load_injectors = 8:' | perl -pe 's:[^/].nb_load_injectors = 12: //.nb_load_injectors = 12:' > ${mainDir}/main.c.tmp
mv ${mainDir}/main.c.tmp ${mainDir}/main.c
make -C ${mainDir} -j

echo "Run 1"
${tcmalloc} ${mainDir}/main 1 8 | tee log_ycsb_1
...
#
# rm -f /mnt/ssd*/kvell/* # Change in # workers, reset DB
